...
function checkNotification(position){
    $.ajax({
        url:origin+"user_home/notifications?latitude="+position.coords.latitude+"&longitude="+position.coords.longitude+"&session_token="+localStorage.getItem("session_token"),
        type:"POST",
